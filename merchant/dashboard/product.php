			...
			<div class="center-block">
				...
				<div>
					<form class="pdct-form">
						...
						<div class="form-group">
							<textarea id="description" onchange="validate({'id':'description','name':'description','regex':null,'length':null,'min_length':9,'max_length':255})" type="text" placeholder="255 char long description" name="p_description"></textarea>
						</div>
						<div class="form-group">
