                ...
                <div id="main-str-cnr">
					<form class="jk-form pdct-form" id="stafrm" enctype="multipart/form-data">
						...
						<div class="form-group">
							<h3>Social Links</h3>
							<p>Facebook Link</p>
							<input id="st_fb_lnk" class="jk-textbox" onchange="validate({'id':'st_fb_lnk','name':'Facebook Link','regex':/^([\w]+)\.facebook\.([\w\W]+)\/([\w\W]+)$/,'length':null,'min_length':9,'max_length':null})" type="text" placeholder="https://www.facebook.com/jhondoe" name="st_fb_lnk"/>

							<p>Twitter Link</p>
							<input id="st_tw_lnk" class="jk-textbox" onchange="validate({'id':'st_tw_lnk','name':'Twitter Link','regex':/^([\w]+)\.twitter\.([\w\W]+)\/([\w\W]+)$/,'length':null,'min_length':9,'max_length':null})" type="text" placeholder="https://www.twitter.com/jhondoe" name="st_tw_lnk"/>

							<p>Google+ Link</p>
							<input id="st_go_lnk" class="jk-textbox" onchange="validate({'id':'st_go_lnk','name':'Google+ Link','regex':/^([\w]+)\.google\.([\w\W]+)\/([\w\W]+)$/,'length':null,'min_length':9,'max_length':null})" type="text" placeholder="https://www.google.com/jhondoe" name="st_go_lnk"/>

							<p>Instagram Link</p>
							<input id="st_in_lnk" class="jk-textbox" onchange="validate({'id':'st_in_lnk','name':'Instagram Link','regex':/^([\w]+)\.instagram\.([\w\W]+)\/([\w\W]+)$/,'length':null,'min_length':9,'max_length':null})" type="text" placeholder="https://www.instagram.com/jhondoe" name="st_in_lnk"/>

							<p>Youtube Link</p>
							<input id="st_yt_lnk" class="jk-textbox" onchange="validate({'id':'st_yt_lnk','name':'Youtube Link','regex':/^([\w]+)\.youtube\.([\w\W]+)\/([\w\W]+)$/,'length':null,'min_length':9,'max_length':null})" type="text" placeholder="https://www.youtube.com/jhondoe" name="st_yt_lnk"/>
